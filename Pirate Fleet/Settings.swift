...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! The computer gets a guaranteed hit on one of your ships."
        static let ComputerHitMonster = "The computer has hit a sea monster! You get a guaranteed hit on one of the computer's ships."
